...
from src.app.inferenceApi.yoloDetectionUtils import *

model = load_model(f"{pathlib.Path(__file__).resolve().parent}/weights/best_detection_yolo_small.pt")

app = FastAPI(title="YOLO X ray Object Detection API")
